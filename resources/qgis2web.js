...
map.getView().fit([-2749778.257387, 9248269.449550, -1468275.183633, 10013169.438924], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Á eða Í, þarna er efinn!</h2>';
        return titleElement;
    })(),
